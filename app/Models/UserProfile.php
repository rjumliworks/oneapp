...
class UserProfile extends Model
{
    ...
    protected $guarded = [];
    protected $fillable = ['firstname', 'lastname', 'middlename','suffix','sex','contact_no','mobile','user_id', 'avatar','signature','is_soloparent','birthdate','marital_id','religion_id','blood_id'];
