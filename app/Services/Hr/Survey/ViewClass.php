...
namespace App\Services\Hr\Survey;
...
use App\Http\Resources\Hr\SurveyResource;

class ViewClass
{
    public function lists($request){
        $data = SurveyResource::collection(
    ...
    public function view($code){
        ...
        $data = new DefaultResource(
            Survey::with('semester','answers','user.profile') ->where('id',$id)->first()
        );
        return $data;
    }
