<template>
    ...
    <PageHeader title="Equipments" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">Masterlist of Equipments </span></h5>
                            <p class="text-muted text-truncate-two-lines fs-12">Overview of all equipment records maintained within the organization.</p>
                        </div>
                    ...
                    <b-row class="mb-2 ms-1 me-1" style="margin-top: 12px;">
                        <b-col lg>
                            <div class="input-group mb-1">
                                ...
                                <input type="text" v-model="filter.keyword" placeholder="Search Equipment" class="form-control" style="width: 40%;">
                        ...
                        <table class="table align-middle table-striped table-centered mb-0">
                            ...
                            <tbody class="table-white fs-12">
                                <tr v-for="(list,index) in lists" v-bind:key="index" >
                                    ...
                                    <td class="text-center">{{ list.last_maintenance }}</td>
    ...
    <Create :stations="dropdowns.stations" ref="create"/>
