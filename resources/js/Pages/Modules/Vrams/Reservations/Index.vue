<template>
    <Head title="Vehicle Reservation"/>
    <PageHeader title="Vehicle Reservation" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">Vehicle Reservation Requests</span></h5>
                        ...
                        <table class="table align-middle table-striped table-centered mb-0">
                            <thead class="table-light thead-fixed">
                                <tr class="fs-11">
                                    ...
                                    <th style="width: 15%;" class="text-center">Reserved Dates</th>
                            ...
                            <tbody class="table-white fs-12">
                                <tr class="ribbon-box" v-for="(list,index) in lists" v-bind:key="index" >
                                    <td class="text-center">
                                        <div v-if="list.type == 'Travel Order'" class="ribbon-two ribbon-two-primary"><span style="font-size: 7px;">Travel Order</span></div>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <!-- <a href="javascript: void(0);" class="d-inline-block" v-b-tooltip.hover="{title: list.name,placement: 'top',customClass: 'my-tooltip-class'}"> -->
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <Link v-if="list.type == 'Travel Order'" :href="`/travels/${list.key}`">
                                            <b-button variant="soft-info" class="me-1" v-b-tooltip.hover title="View" size="sm">
                                                <i class="ri-eye-fill align-bottom"></i>
                                            </b-button>
                                        </Link>
                                        <Link v-else :href="`/reservations/${list.key}`">
                                            <b-button variant="soft-info" class="me-1" v-b-tooltip.hover title="View" size="sm">
                                                <i class="ri-eye-fill align-bottom"></i>
                                            </b-button>
                                        </Link>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url){
            page_url = page_url || '/reservations';
            axios.get(page_url,{
                params : {
