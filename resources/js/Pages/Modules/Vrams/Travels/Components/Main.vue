                    ...
                    <div class="d-flex border border-dashed rounded p-3">
                        <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                            <div class="avatar-title bg-light rounded-circle fs-16 text-primary">
                                <i :class="(information.approved) ? 'text-success' : 'text-warning'" class="ri-emotion-happy-fill"></i>
                            </div>
                        </div>
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="mb-0 fs-12">Recommended By :</p>
                            <h6 v-if="information.recommended" class="text-truncate fw-semibold fs-12 mb-0"> {{ information.recommended }} </h6>
