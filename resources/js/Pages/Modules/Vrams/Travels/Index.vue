<template>
    <Head title="Travel Order"/>
        <PageHeader title="Travel Order" pageTitle="List" />
        <BRow>
            <div class="col-md-12">
                    ...
                    <div class="card-header bg-light-subtle">
                        <div class="d-flex mb-n3">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><span class="text-body">Travel Orders</span></h5>
                        ...
                        <b-row class="mb-2 ms-1 me-1" style="margin-top: 12px;">
                            <b-col lg>
                                <div class="input-group mb-1">
                                    ...
                                    <Multiselect class="white" style="width: 20%;" :options="dropdowns.leaves" v-model="filter.leave" label="name" :searchable="true" placeholder="Select Leave type" />
                            ...
                            <table class="table align-middle table-centered mb-0">
                                <thead class="table-light thead-fixed">
                                    <tr class="fs-11">
                                        <th style="width: 3%;"></th>
                                        <th>Name</th>
                                        <th style="width: 17%;" class="text-center">Leave</th>
                                        <th style="width: 10%;" class="text-center">No. of days</th>
                                        <th style="width: 13%;" class="text-center">Inclusive Date</th>
                                        <th style="width: 15%;" class="text-center">Date Requested</th>
