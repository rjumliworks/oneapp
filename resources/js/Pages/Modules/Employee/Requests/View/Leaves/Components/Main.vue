        ...
        <div class="card-header bg-light-subtle">
            <div class="d-flex mb-n3">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 fs-14"><span class="text-body">Leave Form Activity</span></h5>
...
export default {
    components: { simplebar, Multiselect, Home, Signatories, Attachment, Detail },
    props: ['information'],
    data(){
        return {
            form: useForm({
            ...
            menus: [
                'Home','Signatories','Details','Attachment'
            ],
            menu: 'Home',
            replyuser: null,
            now: dayjs()
